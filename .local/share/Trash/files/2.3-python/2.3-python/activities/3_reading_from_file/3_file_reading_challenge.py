...
chapter1 = open('frankenstein/chapter_1.txt').read()
chapter2 = open('frankenstein/the_second_chapter.txt').read()
chapter3 = open('frankenstein/AND_here_is_THE_third.txt').read()
...
# See if you can use Bash & Python in conjunction to reconstruct the whole HTML
# page using this technique into a HTML file.
