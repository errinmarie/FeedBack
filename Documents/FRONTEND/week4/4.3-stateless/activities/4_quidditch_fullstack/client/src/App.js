...
// TODO, Remove this stuff entirely, instead utilize the doRefresh method
      ...
      .then(data => {
        ...
        fetch('/api/get/chosen/')
          ...
          .then(data => {
            ...
            // TODO, need to add some setState
          });
      });
  }
  */
  ...
  onChooseKeeper = (index) => {
    // TODO, Remove this stuff, instead do API call then doRefresh
  ...
  removeSeeker = () => {
    // TODO, Remove this stuff entirely... the API now takes care of removing
