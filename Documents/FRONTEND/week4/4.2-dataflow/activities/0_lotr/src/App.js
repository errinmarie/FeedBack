            ...
            <section id="main">
                ...
                <section className="CharacterCardGroup">
                    ...
                    <div className="CharacterCard">
                        ...
                        <p><strong>Bio:</strong> Arwen is the Half-Elven
                        daughter of Elrond and Celebrían. She is often called
                        Arwen Undómiel or "Evenstar". Arwen was born in TA 241,
                        to Lord Elrond and Lady Celebrían of Rivendell. Like
                        her father and brothers, she had the right to choose
                        between immortality or mortal life. She lived most of
                        her life in Rivendell and Lothlórien
                        interchangeably.</p>
                        ...
                        <p><strong>Title:</strong> Lady of Rivendell, Queen of
                        the Reunited Kingdom</p>
                    </div>
                    ...
                    <div className="CharacterCard">
                        ...
                        <p><strong>Bio: </strong>
                        Gandalf joined Thorin and his company to reclaim the
                        Lonely Mountain from Smaug, convoked the Fellowship of
                        the Ring to destroy the One Ring, and leads the Free
                        ...
                        Elf-friend, Istar (Wizard), Wielder of the Flame of
                        Anor, Ring-bearer</p>
                    </div>
                    ...
                    <div className="CharacterCard">
                        ...
                        <p><strong>Title:</strong> Prince of the Woodland
                        Realm</p>
                    </div>
                </section>
            </section>
